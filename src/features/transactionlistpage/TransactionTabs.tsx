...
import { useFetchListTransaction } from "./hooks/useListTransaction";
...
export default function TransactionTabs() {
  ...
  return (
    <Fragment>
      <div className="container max-w-4xl mb-7 mx-auto border-1 shadow-lg px-8 py-4">
        {isLoading ? (
